<template>
    <div class="create">
        <div class="tile-block my-4">
            <h3 class="mb-3 border-bottom border-success">Create Stock</h3>
            <form action="" class="form-group">
                ...
                <div class="input-group mb-2">
                    ...
                    <input type="text" class="form-control" v-model="form.model" placeholder="Invoice No." />
                </div>
...
export default {
    ...
    methods: {
        create(){
            if(this.form.model){
                this.$store.dispatch('CREATE_VEHICLE',this.form);
